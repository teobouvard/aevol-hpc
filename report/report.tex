...
Lorsque de la phase d'échange des population d'un pas de temps au suivant, il peut être plus performat d'échanger les pointeurs que de copier les éléments du tableau dans une boucle.
...
On observe que l'échange de pointeur est en général moins performant que la boucle d'échange.
L'hypothèse émise est que le compilateur est capable d'optimiser la boucle d'échange de la stratégie \textit{for\_swap} pour que celle-ci soit
