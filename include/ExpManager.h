 ...
 * ExpManager is in charge of running the simulation and maintaining all the
 * data. It is also that class that implements checkpointing and restore
 * mechanisms.
 */
...
#endif
public:
  ExpManager(int grid_height, int grid_width, int seed, double mutation_rate,
             int init_length_dna, int backup_step);
